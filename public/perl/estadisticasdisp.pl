...
# TITLE:	 	estadisticasdisp.pl
# DESCRIPTION:	genera los datos para los graficos de los dispositivos
# AUTHOR:		José Serena
# DATE:			07/09/2015
# VERSION:		4.0
...
while (my @row = $sth->fetchrow_array) {
	...
	$orden="SELECT ip,date FROM netmap where mac='$row[2]'";
...
my $idx = 0;
foreach my $tipo ( sort keys %hgraftipos ) {
	print "datos2[$idx] = ['$tipo', $hgraftipos{$tipo}]\n";
	$idx++;
}
