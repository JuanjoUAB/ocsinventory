...
# TITLE:	 	firmas_av.pl
# DESCRIPTION:	lista por pantalla la fecha de las firmas AntiVirus de McAfee
# AUTHOR:		José Serena
# DATE:			07/09/2015
# VERSION:		4.0
...
print "document.write('<th class=\"group-false\">Version AV</th>');\n";
print "document.write('<th class=\"group-false\">Version Motor</th>');\n";
print "document.write('<th class=\"group-false\">Version DAT</th>');\n";
print "document.write('<th class=\"group-false sorter-ddmmyyyy\">Fecha DAT</th>');\n";
...
while (@row = $sth->fetchrow_array) {
	...
	print "document.write('<tr><td>$nombre</td><td>$row[2]</td><td>$centro</td><td>$row[3]</td><td>$vav</td><td>$vmotor</td><td>$vdat</td><td>$fechadat</td><td>$diasav</td></tr>');\n";
}
