...
# TITLE:	 	grabarcontmodif.pl
# DESCRIPTION:	graba en la BD el contacto modificado
# AUTHOR:		José Serena
# DATE:			07/09/2015
# VERSION:		4.0
...
my $res = $dbh->do("UPDATE contactos SET tipocont='$datos{tipocont}', nombre='$datos{nombre}', apellidos='$datos{apellidos}', empresa='$datos{empresa}',
											cargo='$datos{cargo}', telefono1='$datos{telefono1}', telefono2='$datos{telefono2}', correo='$datos{correo}', notas='$datos{notas}' 											
					WHERE ID='$datos{id}'");
